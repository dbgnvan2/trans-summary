...
class HeaderValidator:
    def __init__(self, api_key: str, logger):
        ...
        self.terms_file = config.PROMPTS_DIR / \
            config.PROMPT_PROBLEMATIC_HEADER_TERMS_FILENAME
        self.prompt_file = config.PROMPTS_DIR / \
    ...
    def _save_report(self, input_path: Path, results: List[Dict]):
        ...
        with open(report_path, 'w', encoding='utf-8') as f:
            f.write(f"# Header Validation Report\n")
